namespace MaterialSkin
{
    ...
    public class MaterialSkinManager
    {
        ...
        private MaterialSkinManager()
        {
            ...
            NotoSansFontFamilies = new Dictionary<string, FontFamily>();
            foreach (FontFamily ff in privateFontCollection.Families.ToArray())
            {
                NotoSansFontFamilies.Add(ff.Name.Replace(' ', '_'), ff);
            }

            // create and save font handles for GDI
            logicalFonts = new Dictionary<string, IntPtr>(18);
            logicalFonts.Add("H1", createLogicalFont("Noto Sans KR Light", 96, NativeTextRenderer.logFontWeight.FW_LIGHT));
            logicalFonts.Add("H2", createLogicalFont("Noto Sans KR Light", 60, NativeTextRenderer.logFontWeight.FW_LIGHT));
            logicalFonts.Add("H3", createLogicalFont("Noto Sans KR", 48, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H4", createLogicalFont("Noto Sans KR", 34, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H5", createLogicalFont("Noto Sans KR", 24, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H6", createLogicalFont("Noto Sans KR Medium", 20, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("Subtitle1", createLogicalFont("Noto Sans KR", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Subtitle2", createLogicalFont("Noto Sans KR Medium", 14, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("SubtleEmphasis", createLogicalFont("Noto Sans KR", 12, NativeTextRenderer.logFontWeight.FW_NORMAL, 1));
            logicalFonts.Add("Body1", createLogicalFont("Noto Sans KR", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Body2", createLogicalFont("Noto Sans KR", 14, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Button", createLogicalFont("Noto Sans KR Medium", 14, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("Caption", createLogicalFont("Noto Sans KR", 12, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Overline", createLogicalFont("Noto Sans KR", 10, NativeTextRenderer.logFontWeight.FW_REGULAR));
            // Logical fonts for textbox animation
            logicalFonts.Add("textBox16", createLogicalFont("Noto Sans KR", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox15", createLogicalFont("Noto Sans KR", 15, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox14", createLogicalFont("Noto Sans KR", 14, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox13", createLogicalFont("Noto Sans KR Medium", 13, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("textBox12", createLogicalFont("Noto Sans KR Medium", 12, NativeTextRenderer.logFontWeight.FW_MEDIUM));
        }
        ...
        public Font getFontByType(fontType type)
        {
            ...
            {
                case fontType.H1:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR_Light"], 96f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.H2:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR_Light"], 60f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.H3:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 48f, FontStyle.Bold, GraphicsUnit.Pixel);

                case fontType.H4:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 34f, FontStyle.Bold, GraphicsUnit.Pixel);

                case fontType.H5:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 24f, FontStyle.Bold, GraphicsUnit.Pixel);

                case fontType.H6:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR_Medium"], 20f, FontStyle.Bold, GraphicsUnit.Pixel);

                case fontType.Subtitle1:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 16f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.Subtitle2:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR_Medium"], 14f, FontStyle.Bold, GraphicsUnit.Pixel);
                
                case fontType.SubtleEmphasis:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 12f, FontStyle.Italic, GraphicsUnit.Pixel);

                case fontType.Body1:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 14f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.Body2:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 12f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.Button:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 14f, FontStyle.Bold, GraphicsUnit.Pixel);

                case fontType.Caption:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 12f, FontStyle.Regular, GraphicsUnit.Pixel);

                case fontType.Overline:
                    return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 10f, FontStyle.Regular, GraphicsUnit.Pixel);
            }
            return new Font(NotoSansFontFamilies["Noto_Sans_KR"], 14f, FontStyle.Regular, GraphicsUnit.Pixel);
        }
        ...
        private Dictionary<string, FontFamily> NotoSansFontFamilies;
